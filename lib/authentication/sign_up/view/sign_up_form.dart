...
import 'package:shopping_list/authentication/core/src/login_status.dart';
      ...
      builder: (context, state) {
        return TextField(
          ...
          decoration: InputDecoration(
            ...
            helperText: '',
            errorText:
                state.confirmedPassword.isValid ? 'invalid password' : null,
          ),
        );
      },
    );
      ...
      builder: (context, state) {
        return (state.status == LoginStatus.submissionInProgress)
            ...
            : ElevatedButton(
                ...
                onPressed: (state.credentialsAreValid())
